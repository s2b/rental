	...
	<fieldset id="modal">
		...
		<dl>
			...
			<dd>
				...
				<input type="text" name="title" id="title" size="30" value="<?php echo set_value('title', $package->title) ?>" />
			</dd>
		</dl>
		<dl>
			...
			<dd>
				...
				<input type="text" name="desc" id="desc" size="30" value="<?php echo set_value('desc', $package->desc) ?>" />
			</dd>
		</dl>
		<dl>
